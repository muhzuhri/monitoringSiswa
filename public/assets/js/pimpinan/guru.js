document.addEventListener("DOMContentLoaded", function () {
    let currentSiswas = [];
    const filterSelect = document.getElementById("g_filter_periode");
    const listContainer = document.getElementById("g_supervised_list");
                ...
                studentDiv.innerHTML = `
                    <div class="user-mini-card shadow-sm border h-100">
                        <div class="user-mini-header">
                            <div class="user-mini-icon bg-primary shadow-sm" style="width:36px; height:36px; font-size:0.9rem;">
    ...
    detailButtons.forEach((button) => {
        button.addEventListener("click", function () {
            ...
            document.getElementById("g_det_nama").textContent = this.getAttribute("data-nama");
            document.getElementById("g_det_id_guru").textContent = this.getAttribute("data-id_guru");
            document.getElementById("g_det_email").textContent = this.getAttribute("data-email");
            document.getElementById("g_det_sekolah").textContent = this.getAttribute("data-sekolah");
            document.getElementById("g_det_jabatan").textContent = this.getAttribute("data-jabatan");

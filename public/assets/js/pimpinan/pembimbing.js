document.addEventListener("DOMContentLoaded", function () {
    ...
    detailButtons.forEach((button) => {
        button.addEventListener("click", function () {
            document.getElementById("det_name").textContent =
            ...
            document.getElementById("det_telp").textContent =
                this.getAttribute("data-telp");
            document.getElementById("det_instansi").textContent =
            ...
            if (siswas.length > 0) {
                ...
                listContainer.innerHTML =
                    '<div class="col-12 text-muted">Belum ada siswa yang diploting ke pembimbing ini.</div>';
            }
        });
    });
});

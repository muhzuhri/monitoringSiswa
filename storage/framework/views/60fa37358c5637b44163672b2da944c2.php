...
<div class="modal fade" id="modalTambahSiswa" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
            <form method="POST" action="<?php echo e(route('admin.storeSiswa')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                                            ...
                                            <div class="p-input-wrapper">
                                                ...
                                                <select name="id_guru" id="edit_id_guru" class="p-input with-icon">
                                                    ...
                                                    <?php $__currentLoopData = $gurus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($g->id_guru); ?>"><?php echo e($g->nama); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <div class="p-input-wrapper">
                                                ...
                                                <select name="id_pembimbing" id="edit_id_pembimbing" class="p-input with-icon">
                                                    ...
                                                    <?php $__currentLoopData = $pembimbings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($d->id_pembimbing); ?>"><?php echo e($d->nama); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
...
<?php /**PATH C:\laragon\www\monitoringSiswa\resources\views/admin/kelolaSiswaModals.blade.php ENDPATH**/ ?>
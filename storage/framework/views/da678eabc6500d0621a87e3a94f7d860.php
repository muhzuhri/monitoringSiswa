...
<?php $__env->startSection('title', 'Manajemen Pembimbing Lapangan - Monitoring Siswa Magang'); ?>
<?php $__env->startSection('body-class', 'dashboard-page admin-page'); ?>

<?php $__env->startSection('body'); ?>
    <?php $__env->startPush('styles'); ?>
        <link rel="stylesheet" href="<?php echo e(asset('assets/css/admin/kelola-dosen.css')); ?>">
        ...
        <div class="admin-content-wrapper">
            ...
            <div class="management-header">
                <div class="header-title">
                    ...
                    <small>Total <?php echo e($pembimbing->total()); ?> pembimbing lapangan terdaftar.</small>
                </div>
                                ...
                                <td data-label="Aksi">
                                    <div class="action-group">
                                        ...
                                        <button class="btn-icon btn-edit-soft btn-edit" data-bs-toggle="modal"
                                            data-bs-target="#modalEditDosen" data-id="<?php echo e($item->id_pembimbing); ?>"
                                            data-nama="<?php echo e($item->nama); ?>" data-email="<?php echo e($item->email); ?>"
                                            data-jabatan="<?php echo e($item->jabatan); ?>" data-instansi="<?php echo e($item->instansi); ?>"
                                            data-telp="<?php echo e($item->no_telp); ?>">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button class="btn-icon btn-delete-soft btn-delete-trigger" data-bs-toggle="modal"
                                            data-bs-target="#modalHapus"
                                            data-url="<?php echo e(route('admin.destroyPembimbing', $item->id_pembimbing)); ?>">
    ...
    <div class="modal fade" id="modalTambahDosen" tabindex="-1">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <form method="POST" action="<?php echo e(route('admin.storePembimbing')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script src="<?php echo e(asset('assets/js/admin/kelolaPembimbing.js')); ?>"></script>
    <?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.nav.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\monitoringSiswa\resources\views/admin/kelolaPembimbing.blade.php ENDPATH**/ ?>
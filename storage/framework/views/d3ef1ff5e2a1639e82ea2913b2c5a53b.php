        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="nav-list ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Route::is('pimpinan.siswa') || Route::is('pimpinan.guru') || Route::is('pimpinan.pembimbing') || Route::is('pimpinan.admin') ? 'active' : ''); ?>" href="<?php echo e(route('pimpinan.admin')); ?>">Kelola Akun</a>
                    </li>                    
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Route::is('pimpinan.rekap') ? 'active' : ''); ?>" href="<?php echo e(route('pimpinan.rekap')); ?>">Rekap</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Route::is('pimpinan.profil') ? 'active' : ''); ?>" href="<?php echo e(route('pimpinan.profil')); ?>">Profil</a>
                    </li>
                </ul>
                <div class="d-flex align-items-center gap-3">
                    <div class="user-profile-nav d-none d-lg-flex">
                        <div class="user-info text-end">
                            <div class="user-name text-white"><?php echo e($user->nama); ?></div>
...
<?php /**PATH C:\laragon\www\monitoringSiswa\resources\views/layouts/nav/pimpinan.blade.php ENDPATH**/ ?>
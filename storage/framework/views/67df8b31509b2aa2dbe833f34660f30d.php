<?php $__env->startSection('title', 'Profil Admin - SIM Magang'); ?>
<?php $__env->startSection('body-class', 'admin-page profil-page'); ?>

<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/admin/profil-admin.css')); ?>">
<?php $__env->stopPush(); ?>
    ...
    <div class="page-wrapper">
        <div class="page-header">
            <div>
                ...
                <p class="page-subtitle">Kelola informasi akun dan pengaturan keamanan (Administrator).</p>
            </div>
        </div>
        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade show active" id="pills-biodata" role="tabpanel">
                <div class="laporan-grid max-w-800 mx-auto">
                    <div class="ui-card">
                        <h5 class="page-title mb-1-5">Informasi Akun Admin</h5>
            ...
            <div class="tab-pane fade" id="pills-keamanan" role="tabpanel">
                <div class="laporan-grid max-w-800 mx-auto">
                    <div class="ui-card">
                        ...
                        <form action="<?php echo e(route('admin.profil.password')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
...
<?php echo $__env->make('layouts.nav.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\monitoringSiswa\resources\views/admin/profil.blade.php ENDPATH**/ ?>
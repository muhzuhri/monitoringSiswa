<?php $__env->startSection('title', 'Pusat Rekapitulasi Data - Pimpinan Dashboard'); ?>
<?php $__env->startSection('body-class', 'dashboard-page pimpinan-page'); ?>

<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/pimpinan/rekap.css')); ?>">
<?php $__env->stopPush(); ?>

<?php $__env->startPush('scripts'); ?>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.11.174/pdf.min.js"></script>
    <script src="<?php echo e(asset('assets/js/pimpinan/rekap.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php $__env->startSection('body'); ?>
    <div class="dashboard-container" id="rekap-container" data-stats-url="<?php echo e(route('pimpinan.rekap.stats')); ?>">
                ...
                <div class="tab-pane fade show active" id="siswa-pane" role="tabpanel">
                    <div class="rekap-grid">
                        ...
                        <div class="rekap-card">
                            ...
                            <div class="rekap-card-count" id="statSiswaAktif"><?php echo e($stats['siswa_aktif']); ?></div>
                            <h5 class="rekap-card-title">Mahasiswa/Siswa Aktif</h5>
                            <a href="javascript:void(0)" data-url="<?php echo e(route('admin.rekap.siswaAktif')); ?>" class="rekap-btn-download btn-preview-pdf">
                        ...
                        <div class="rekap-card">
                            ...
                            <div class="rekap-card-count" id="statSiswaSelesai"><?php echo e($stats['siswa_selesai']); ?></div>
                            <h5 class="rekap-card-title">Siswa Selesai Magang</h5>
                            <a href="javascript:void(0)" data-url="<?php echo e(route('admin.rekap.siswaSelesai')); ?>" class="rekap-btn-download btn-preview-pdf">
                                <i class="fas fa-file-pdf"></i>
                                <span>Preview Rekap</span>
                            </a>
                        </div>
                        ...
                        <div class="rekap-card">
                            ...
                            <div class="rekap-card-count" id="statTotalSiswa"><?php echo e($stats['total_siswa']); ?></div>
                            <h5 class="rekap-card-title">Total Keseluruhan Siswa</h5>
                            <a href="javascript:void(0)" data-url="<?php echo e(route('admin.rekap.siswaTotal')); ?>" class="rekap-btn-download btn-preview-pdf">
                                <i class="fas fa-file-pdf"></i>
                                <span>Preview Rekap</span>
                            </a>
                        </div>
                ...
                <div class="tab-pane fade" id="guru-pane" role="tabpanel">
                    <div class="rekap-grid">
                        <div class="rekap-card">
                            ...
                            <div class="rekap-card-count" id="statTotalGuru"><?php echo e($stats['total_guru']); ?></div>
                            <h5 class="rekap-card-title">Total Guru Pembimbing</h5>
                            <a href="javascript:void(0)" data-url="<?php echo e(route('admin.rekap.guru')); ?>" class="rekap-btn-download btn-preview-pdf">
                                <i class="fas fa-file-pdf"></i>
...
<?php echo $__env->make('layouts.nav.pimpinan', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\monitoringSiswa\resources\views/pimpinan/rekap.blade.php ENDPATH**/ ?>
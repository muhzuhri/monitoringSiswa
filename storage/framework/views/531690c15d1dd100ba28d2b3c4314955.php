<?php $__env->startSection('title', 'Dashboard Siswa - SIM Magang Fasilkom Unsri'); ?>
<?php $__env->startSection('body-class', 'dashboard-page siswa-page'); ?>

<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/siswa/siswa.css')); ?>">
<?php $__env->stopPush(); ?>

<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('assets/js/siswa/home-siswa.js')); ?>"></script>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('layouts.nav.siswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\monitoringSiswa\resources\views/siswa/siswa.blade.php ENDPATH**/ ?>
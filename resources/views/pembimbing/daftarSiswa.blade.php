                                        ...
                                        <td class="text-center">
                                            <div class="action-buttons justify-content-center">
                                                <button class="btn-action-icon btn-view btn-show-profile" 
                                                        data-siswa="{{ json_encode($siswa) }}" title="Lihat Profil">
                                                    <i class="fas fa-user-circle text-primary"></i> <span class="text-primary">Profil</span>
                                                </button>
                                                <a href="{{ route('pembimbing.logbook', $siswa->nisn) }}" class="btn-action-icon btn-view" title="Logbook">
                                                    <i class="fas fa-book"></i>
                                                </a>
                                                <a href="{{ route('pembimbing.absensi', $siswa->nisn) }}" class="btn-action-icon btn-view" title="Absensi">
                                    ...
                                    <tr class="student-row">
                                        ...
                                        <td class="text-center">
                                            <div class="action-buttons justify-content-center">
                                                ...
                                                {{-- Cetak Penilaian (Supervisor Assessment) --}}
                                                <a href="{{ route('pembimbing.laporan.cetak', $siswa->nisn) }}" class="btn-action-icon btn-view" title="Cetak Penilaian" style="background:var(--color-purple-lt); color:var(--color-primary);">
                                                    <i class="fas fa-star-half-alt"></i>
                                                </a>

                                                {{-- Cetak Kegiatan (Siswa's Logbook Template) --}}
                                                <a href="{{ route('pembimbing.siswa.cetakJurnal', $siswa->nisn) }}" class="btn-action-icon btn-view" title="Cetak Jurnal Kegiatan" style="background:var(--color-blue-lt); color:var(--color-blue);">
                                                    <i class="fas fa-book"></i>
                                                </a>

                                                {{-- Cetak Absensi (Siswa's Individual Attendance Template) --}}
                                                <a href="{{ route('pembimbing.siswa.cetakAbsensi', $siswa->nisn) }}" class="btn-action-icon btn-view" title="Cetak Absensi Individu" style="background:var(--color-green-lt); color:var(--color-green);">
                                                    <i class="fas fa-calendar-check"></i>
                                                </a>
                                            </div>
                                        </td>

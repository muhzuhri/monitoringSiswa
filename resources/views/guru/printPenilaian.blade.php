...
<body>
    ...
    <table class="main-table">
        ...
        <tbody>
            ...
            @php $i = 1; $totalSkor = 0; $count = 0; @endphp
            @foreach($penilaian->penilaianDetails->where('kriteria.tipe', 'guru_kepribadian') as $detail)
                <tr>
                    <td class="text-center">{{ $i++ }}</td>
                    <td>{{ $detail->kriteria->nama_kriteria }}</td>
                    <td class="text-center">{{ round($detail->skor) }}</td>
                    <td class="text-center">{{ getHuruf($detail->skor) }}</td>
                </tr>
                @php $totalSkor += $detail->skor; $count++; @endphp
            @endforeach
            ...
            @php $j = 1; @endphp
            @foreach($penilaian->penilaianDetails->where('kriteria.tipe', 'guru_kemampuan') as $detail)
                <tr>
            ...
            <tr class="fw-bold">
                ...
                <td class="text-center">{{ round($totalSkor) }}</td>

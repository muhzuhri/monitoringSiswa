...
@section('title', 'Profil Saya - SIM Magang')
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/guru/profil.css') }}">
@endpush
                ...
                <div class="ui-card text-center p-4">
                    ...
                    <div class="sidebar-stats mt-3 pt-3 border-top">
                        <div class="row text-center">
                            <div class="col-12">
                                <span class="d-block fw-bold text-dark">{{ $user->sekolah ?? '-' }}</span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="text" name="nama" class="form-control-modern"
                                            value="{{ old('nama', $user->nama) }}" required placeholder="Nama Lengkap Anda">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="text" name="no_hp" class="form-control-modern"
                                            value="{{ old('no_hp', $user->no_hp) }}" placeholder="e.g 0812XXXXXXXX">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="text" name="jabatan" class="form-control-modern"
                                            value="{{ old('jabatan', $user->jabatan) }}" placeholder="e.g Guru Produktif">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="text" name="sekolah" class="form-control-modern"
                                            value="{{ old('sekolah', $user->sekolah) }}" placeholder="Nama Sekolah Anda">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-modern">
                                        ...
                                        <input type="text" name="npsn" class="form-control-modern"
                                            value="{{ old('npsn', $user->npsn) }}" placeholder="NPSN Sekolah">
                                    </div>
                                </div>
                            </div>
                        </div>

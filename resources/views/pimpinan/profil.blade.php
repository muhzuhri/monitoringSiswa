...
@section('title', 'Profil Pimpinan - SIM Magang')
@section('body-class', 'laporan-page')

@push('styles')
    <link rel="stylesheet" href="{{ asset('assets/css/pimpinan/profil.css') }}?v={{ time() }}">
@endpush
            ...
            <div class="tab-pane fade show active" id="pills-biodata" role="tabpanel">
                <div class="laporan-grid max-w-800 mx-auto">
                    <div class="ui-card">
                        ...
                        <form action="{{ route('pimpinan.profil.update') }}" method="POST">
                            @csrf
                            @method('PUT')
            ...
            <div class="tab-pane fade" id="pills-keamanan" role="tabpanel">
                <div class="laporan-grid max-w-800 mx-auto">
                    <div class="ui-card">
                        ...
                        <form action="{{ route('pimpinan.profil.password') }}" method="POST">
                            @csrf
                            @method('PUT')

...
@section('title', 'Profil Admin - SIM Magang')
@section('body-class', 'admin-page profil-page')

@push('styles')
    <link rel="stylesheet" href="{{ asset('assets/css/admin/profil-admin.css') }}">
@endpush
